...
export JENKINS_X_URL='http://dashboard-jx.34.132.47.65.nip.io/jenkins-serverless-gke/nodeapp-night/master/8'
...
export MINK_IMAGE='gcr.io/compute-project-183119/nodeapp-night:0.0.8'
